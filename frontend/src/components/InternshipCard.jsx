...
const InternshipCard = ({ data, onEdit, onDelete, onView }) => {
    const { title, description, company, supervisor, occupiedSlots, totalSlots, specialtyArea, applicationDeadline } = data;
            ...
            <div className="card-body">
                ...
                <div className="card-details">
                    <div className="detail-item">
                        ...
                        <span>{occupiedSlots || 0} / {totalSlots || 0} Cupos Ocupados</span>
                    </div>
                    <div className="detail-item">
