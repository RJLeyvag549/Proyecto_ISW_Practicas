...
export const createInternshipSchema = Joi.object({
  ...
  .required()
  .messages({
    "number.base": "El número de cupos disponibles debe ser un número.",
    "number.integer": "El número de cupos disponibles debe ser un número entero.",
    "number.min": "El número de cupos disponibles debe ser al menos 1."
  }),
